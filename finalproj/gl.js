...
// START WEBGL:
       ...
       for (var n = 0 ; n < c.length ; n++) {
          ...
          if (c[n].getAttribute("data-render") == "gl") {
             ...
             canvas.handle.addObject = function(vertArray, fragShaderId, life, pos, vel, acc, ori ,size, w, col) {
...
// CREATE THE GL VERTEX BUFFER FOR ONE VERTEX ARRAY:
   ...
   function updateVertexBuffer(gl, vertArray, vertexBuffer) {
...
// DRAW ONE WEBGL CANVAS FOR THIS ANIMATION FRAME
   ...
   function drawScene(canvas) {
      ...
      for (var n = 0 ; n < canvas.handle.objects.length ; )
    	 {
    	  	var t = canvas.handle.objects[n];
    	  	if(t.life>0)
    	  		{
    	  			drawObject(gl, t);
    	  			n++;
    	  	...
    	  	{	
    	  		canvas.handle.objects.splice(n,1);
    	  		//alert(canvas.handle.objects.length);
    	  	}
    	 }
      
      //console.log(canvas.handle.objects.length);
...
// DESIRED STEP SIZE IN U AND V ARE du AND dv, RESPECTIVELY:
   ...
   function createParametric(du, dv, f, filter) {
      var vertices = [];
      ...
      function fd(u, v) {
        ...
        // USER'S FUNCTION f MUST EVALUATE TO AN [x,y,z] POINT:
         ...
         var p = f(u, v);
         var h=vertices[vertices.length-6];
         if(filter)
        	 p=filterVertex(p,h);
	 ...
	 vertices.push(a[0],a[1],a[2], a[3],a[4],a[5], u   , v   );
      ...
      for (var v = 0 ; v < 1 ; v += dv) {
          ...
          var a = fd(u+du,v);
          vertices.push(a[0], a[1], a[2], a[3], a[4], a[5], u+du, v+dv);
          ...
          for (u=1; u > 0-du ; u -= du) {
              ...
              vertices.push(d[0], d[1], d[2], d[3], d[4], d[5], u, v);
              vertices.push(a[0], a[1], a[2], a[3], a[4], a[5], u, v+dv);
          }
          //var a = fd(u+du, v+dv);
          //vertices.push(a[0], a[1], a[2], a[3], a[4], a[5], u, v);
...
// CREATE A CUBE GEOMETRY:
   ...
   function createPlane() {
	      var vertices = [];
	         ...
	         vertices.push(-1, -1, 0, 0,0,1, 0,0);
	         vertices.push(-1, 1, 0, 0,0,1, 0,1);
	         vertices.push(1, -1, 0, 0,0,1, 1,0);
	         vertices.push(1, 1, 0, 0,0,1, 1,1);
